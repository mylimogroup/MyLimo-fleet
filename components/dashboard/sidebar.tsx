    ...
    <>
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-sidebar-border px-6">
          ...
          <div>
            <p className="text-sm font-semibold leading-none">MyLimo Fleet</p>
            <p className="mt-0.5 text-xs text-sidebar-muted">Fleet Management</p>
          </div>
        </div>
        ...
        <div className="border-t border-sidebar-border p-4">
          <div className="flex items-center gap-3 rounded-lg bg-sidebar-hover px-3 py-2.5">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium">Paolo Marini</p>
              <p className="truncate text-xs text-sidebar-muted">Fleet Manager</p>
            </div>
          </div>
        </div>
      </aside>
