            ...
            {drivers.map((driver) => (
              ...
              >
                <td className="px-4 py-3">
                  <Avatar src={driver.photoUrl} name={driver.fullName} />
                </td>
                <td className="px-4 py-3">
                  <Link
                ...
                <td className="px-4 py-3 text-sm tabular-nums">{driver.phone}</td>
                ...
                <td className="px-4 py-3">
                  <ExpirationCell date={driver.drivingLicenseExpiration} />
                </td>
                <td className="px-4 py-3">
                  <ExpirationCell date={driver.cqcExpiration} />
                </td>
                <td className="px-4 py-3">
